...
weakImport("from .protocol_assign_heterogeneity_priors_zernike3d import XmippProtHeterogeneityPriorsZernike3D")
weakImport("from .protocol_angular_alignment_zernike3d import XmippProtAngularAlignmentZernike3D")
