...
class ProtFlexBase:
    ...
    def _createSetOfClassesStructFrameFlex(self, flexFrames, suffix='', **kwargs):
        classes = self._createSet(flexutils.objects.SetOfClassesStructFrameFlex,
                                  'flexClassesStructFrame%s.sqlite', suffix, **kwargs)
        classes.setFrames(flexFrames)
        return classes
    ...
    def _createSetOfAtomStructFlex(self, suffix='', **kwargs):
        return self._createSet(flexutils.objects.SetOfAtomStructFlex,
